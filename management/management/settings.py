...
SECRET_KEY = 'django-insecure-l+b&&=fn*7^(qp45bw%6j4tz*#e^#n^a1py(9t552#6@u2v=r5'
...
DATABASES = {
    'default': {
        ...
        # 'NAME': 'test1',           # Name of your MySQL database
        # 'USER': 'root',                 # Your MySQL username
        # 'PASSWORD': 'admin123',         # Your MySQL password
        # 'HOST': '127.0.0.1',                           # This will correspond to the docker-compose service name
        # 'PORT': '3306',   
        # 'OPTIONS': {
        #     'ssl': {'ca': ''},      # Try setting an empty SSL configuration
        # },                      # Default MySQL port
    }
}
